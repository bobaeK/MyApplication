...
public class DriveMapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton restaurant = (ImageButton)findViewById(R.id.mapRestaurant);
        ...
        ImageButton convenience = (ImageButton)findViewById(R.id.mapConvenience);
        ...
        ImageButton bike = (ImageButton)findViewById(R.id.mapBike);
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher)); //안드로이드 아이콘
    ...
    public void showRestaurantInformation(LatLng location) {
        ...
        new NRPlaces.Builder()
                .listener(DriveMapActivity.this)
